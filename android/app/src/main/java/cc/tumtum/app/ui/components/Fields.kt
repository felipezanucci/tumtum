...
fun TTField(
    ...
    // refusal. Hidden by default; one tap shows it, another hides it again.
    ...
    Column(modifier.fillMaxWidth()) {
        ...
        Row(
            ...
            if (isPassword) {
                Icon(
                    painter = painterResource(if (revealed) R.drawable.ic_eye_off else R.drawable.ic_eye),
                    contentDescription = stringResource(
                        if (revealed) R.string.field_password_hide else R.string.field_password_show,
                    ),
                    tint = if (revealed) TT.Ink else TT.Gray45,
                    modifier = Modifier
                        .padding(start = 10.dp)
                        .size(22.dp)
