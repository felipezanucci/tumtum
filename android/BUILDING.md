...
> **Desde 2026-09-18 este é *o* app** (`docs/one-app-plan.md`, Etapa 0). Veio da
> branch `app` (commit `23b10b8`) para `android/` no `main`; o app de captura
> ficou em `android-capture/` como referência. Os comandos abaixo rodam de
> dentro de `android/`. O CI é `.github/workflows/build-app.yml`: APK de debug
> a cada push, `.aab` de release quando os secrets da chave de upload existem.
