...
60. **Tests 6–10 of the 23/09 round are still to run on b170**: the session
...
Built with the two above (b170), each from a finding in Felipe's hands:
