...
public class ObtainDetailedSleepdataActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sleep_data_read);
    ...
    public void dataCallback(Map<String, Object> maps) {
        ...
        switch (dataType) {
            case BleConst.DeleteSleep:
                showDialogInfo(maps.toString());
                break;
            case BleConst.Obtain_detailed_sleep_data:
                dataCount++;
    ...
    private void getObtainDetailedSleepData(byte mode) {
        /**
