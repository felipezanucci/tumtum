...
import com.jstyle.blesdkv8.callback.OnScanResults;
...
public class BleManager {
    ...
    public void connectDevice(String address, boolean NeedReconnect,BleConnectionListener bleConnectionListener ){
        ...
        if(bleService==null){
            ...
            bleService.connectedDevice(address,this.context,bleConnectionListener);
        }
    }
     ...
     * @return
     */
    public  boolean isPairDevices(String address) {
