...
public class BleConst {
   ...
   public static final String Obtain_detailed_sleep_data="121";
   public static final String DeleteSleep="122";
   public static final String Temperature_3NTC="123";
   public static final String SetBasic_parameters_of_equipment="124";
   public static final String GetBasic_parameters_of_equipment="125";
   public static final String PPG="126";
