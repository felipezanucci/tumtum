...
public class DeviceKey {
    public static final String Is_the_sports_mode_flashing = "Is_the_sports_mode_flashing";
    public static final String Is_the_light_flashing_when_the_Heart_Rate_is_too_high_in_sports_mode = "Is_the_light_flashing_when_the_Heart_Rate_is_too_high_in_sports_mode";
    public static final String Sleep_level = "Sleep_level";
    public static final String ActivityData = "ActivityData";
    ...
    public static final String MTUlength ="MTUlength";
    ...
    public static final String TempData2 = "TempData2";
 ...
 */
    ...
    public static final String EcgWeight = "Height";
