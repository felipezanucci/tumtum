...
export default function HRCurve({
  ...
  useEffect(() => {
    ...
    const gradient = defs
      ...
      .attr('x2', '0%')
      .attr('y2', '100%')
    gradient.append('stop').attr('offset', '0%').attr('stop-color', '#FF2E3C').attr('stop-opacity', 0.3)
    gradient.append('stop').attr('offset', '100%').attr('stop-color', '#FF2E3C').attr('stop-opacity', 0)
